...
VALUES ('zhangsan','快去学习','快去学习','每隔10s','每天计划','5 * * * * ?'),
       ('zhangsan','快去学习','快去学习','每隔10s','每天计划','15 * * * * ?'),
       ('zhangsan','快去学习','快去学习','每隔10s','每天计划','25 * * * * ?'),
       ('zhangsan','快去学习','快去学习','每隔10s','每天计划','35 * * * * ?'),
       ('zhangsan','快去学习','快去学习','每隔10s','每天计划','45 * * * * ?'),
       ('zhangsan','快去学习','快去学习','每隔10s','每天计划','55 * * * * ?'),
       ('lisi','快去学习','快去学习','每隔10s','每天计划','5 * * * * ?'),
       ('lisi','快去学习','快去学习','每隔10s','每天计划','15 * * * * ?'),
